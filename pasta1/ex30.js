...
if (media >= 7) {
    console.log(`O aluno foi aprovado com ${media.toFixed(1)}.`);
}   else if (media >= 5 && media < 7) {
    console.log(`O aluno foi aprovado em exame com ${media.toFixed(1)}.`);
}else {
    console.log(`o aluno foi reprovado com ${media.toFixed(1)}. `);
}
